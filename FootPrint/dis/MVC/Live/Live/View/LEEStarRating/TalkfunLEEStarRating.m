...
- (void)setCurrentScoreChangeBlock:(void (^)(CGFloat currentScoreChange ,NSString * tag ))currentScoreChangeBlock{
    
    _currentScoreChangeBlock = currentScoreChangeBlock;
    
    if (currentScoreChangeBlock) currentScoreChangeBlock(self.currentScore ,self.key);
}
