...
-(void)setupSearchBarView{
    ...
    if (self.leftImgView == nil) {
        ...
        self.leftImgView.image = [UIImage imageNamed:@"ic_search"];
...
//        [self.closeBtn setImage:[UIImage imageNamed:@"search_close"] forState:(UIControlStateNormal)];
...
UILabel *placeholderLabel = object_getIvar(self.textFiled, ivar);
placeholderLabel.font = lc_font;
...
Ivar ivar =  class_getInstanceVariable([UITextField class], "_placeholderLabel");
    UILabel *placeholderLabel = object_getIvar(self.textFiled, ivar);
placeholderLabel.textColor = lc_placeholderColor;
