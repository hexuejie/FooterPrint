...
+ (instancetype)qrCodeViewWithContent:(NSString*)content picture:(UIImage *)picture codeMsg:(NSString *)msg{
    
    TMQRcodeView *qrCodeView = [[NSBundle mainBundle] loadNibNamed:@"TMQRcodeView" owner:self options:nil].lastObject;
    
    [qrCodeView doWithCreateUIWithContent:content picture:picture codeMsg:msg];
...
#pragma mark - UI布局
- (void)doWithCreateUIWithContent:(NSString *)content picture:(UIImage *)picture codeMsg:(NSString *)msg{
