...
- (void)viewDidLoad
{
    ...
    //顶部导航栏左侧按钮
    UIBarButtonItem *leftBarBtn = [UIFactory barBtnMakeWithTitle:@"取消" titleColor:[UIColor blackColor] fontSize:13 isBold:YES event:^{
    ...
    //顶部导航栏右侧按钮
    UIBarButtonItem *rightBarBtn = [UIFactory barBtnMakeWithTitle:@"完成" titleColor:[UIColor blackColor] fontSize:13 isBold:YES event:^{
