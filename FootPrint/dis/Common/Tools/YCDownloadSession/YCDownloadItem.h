...
-(nonnull instancetype)initWithUrl:(nonnull NSString *)url fileId:(nullable NSString *)fileId downloadCid:(NSString *)downloadCid;
+(nonnull instancetype)itemWithUrl:(nonnull NSString *)url fileId:(nullable NSString *)fileId downloadCid:(NSString *)downloadCid;
...
@property (nonatomic, copy, readonly, nonnull) NSString *downloadCid;
