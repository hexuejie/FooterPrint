...
- (void)setPlaceholderImage:(UIImage *)placeholderImage
{
    ...
    if (!self.backgroundImageView) {
        ...
        bgImageView.contentMode = UIViewContentModeCenter;//UIViewContentModeScaleAspectFit;
//        kImgViewFix(bgImageView);
        [self insertSubview:bgImageView belowSubview:self.mainView];
        self.backgroundImageView = bgImageView;
    }
    
    kImgViewFix(self.backgroundImageView);
...
- (void)setShowPageLabel:(BOOL)showPageLabel{
    ...
    _pageLabel.hidden = !showPageLabel;
}
...
- (void)setupPageControl
{
    ...
    self.pageLabel.text = [NSString stringWithFormat:@"1/%ld",self.imagePathsGroup.count];
    self.pageLabel.textColor = [UIColor whiteColor];
    self.pageLabel.font = FONT_Fit(14);
...
//    pageControlFrame.origin.x -= (SCREEN_WIDTH-size.width)/2;
