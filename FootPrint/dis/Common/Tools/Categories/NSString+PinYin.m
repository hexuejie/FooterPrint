...
//    [dict setObject:[NSMutableArray array] forKey:@"默认地址"];
//    NSInteger str = 'e';
//    [dict setObject:[NSMutableArray array]
//             forKey:[NSString stringWithUTF8String:(const char *)&str]];
//    for (int i = 'A'; i <= 'Z'; i++) {
//        [dict setObject:[NSMutableArray array]
//                 forKey:[NSString stringWithUTF8String:(const char *)&i]];
//    }
//    
//    for (AddressModel *model in self) {
//        if ([model.is_default isEqualToString:@"1"]) {
//            
//            NSString *firstLetter = @"默认地址";
//            NSMutableArray *array = dict[firstLetter];
//            [array addObject:model];
//        }else{
//            NSString *firstLetter = [model.full_name getFirstLetter];
//            NSMutableArray *array = dict[firstLetter];
//            [array addObject:model];
//        }
//    }
...
//    
//    if ([dict[@"默认地址"] count]) {
//        NSMutableArray *array = dict[@"默认地址"];
//        [array sortUsingComparator:^NSComparisonResult(AddressModel *obj1, AddressModel *obj2) {
//            NSString *word1 = obj1.full_name;
//            NSString *word2 = obj2.full_name;
