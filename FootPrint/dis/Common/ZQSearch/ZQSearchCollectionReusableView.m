...
//
//    [deleteBtn setImage:[UIImage iconWithInfo:TBCityIconInfoMake(@"\U0000e673", 24, [UIColor colorWithHex:0x666666])] forState:UIControlStateNormal];
...
- (void)hideDeleteHistoryBtn {
    self.button.hidden = YES;
}
- (void)showDeleteHistoryBtn {
